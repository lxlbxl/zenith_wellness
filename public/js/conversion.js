...
(function () {
    ...
    function initLiveFeed() {
        ...
        function showNotification(activity) {
            ...
            const programText = container.querySelector('.program-text');
            programText.innerHTML = '';
            const strong = document.createElement('strong');
            strong.textContent = activity.program;
            programText.appendChild(strong);
            programText.appendChild(document.createTextNode(` ${activity.time}`));
